...
<?php 
 ...
 ?> 
   <tr>
        <td><a href="cart.php?index=<?php echo $index; ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger">Delete</a> </td>
    ...
    <tr>
      <td colspan="6" style="text-align:right;"><a href="homeAdmin.php" class="btn btn-success">Tambah Barang Lagi</a><a href="data_pembeli_admin.php"class="btn btn-primary">Pembayaran</a></td>
    </tr>
</table>
</form>
<br>
