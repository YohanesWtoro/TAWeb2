    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="data_terima_kasir.php">Data Kiriman Barang</a>
        </div>
      </li>
      </ul>
      <form action="homeKasir.php" method="get" class="form-inline my-2 my-lg-0">
...
<h1 class="text-center">Kasir</h1><br>
    ...
    <?php } ?>
    <tr>
      <td colspan="5" style="text-align:right;"><a href="cart.php" class="btn btn-primary">Keranjang Belanja</a></td>
         </table>
