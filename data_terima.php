...
<div style="text-align: center; background-color: #e39434; font-family: arial;"><h1>TOKO FURNITURE</h1></div>
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      <form class="form-inline my-2 my-lg-0" action="data_terima.php" method="get">
  ...
  <div><a href="input_terima.php" class="btn  btn-success ml-3">Tambah Terima Barang</a></div>
      ...
      <table class="table table-bordered table-hover table-striped mt-2">   
       ...
       echo "<tr>
                ...
                <td align='right' width='20px'><a href='form_editterima .php?id_kiriman=$krm[id_kiriman]' type='button' class='btn btn-primary'>Perbaharui</a></td>
                <td  width='20px'><a href='hapuskiriman.php?id_kiriman=$krm[id_kiriman]' class='btn btn-danger' onclick='return confirm(`Apakah Yakin Akan Dihapus?`)'>Hapus</a></td>
                  </tr>";
                  $no++;
      }
      ?>
