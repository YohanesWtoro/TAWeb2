...
<div style="text-align: center; background-color: #e39434; font-family: arial;"><h1>TOKO FURNITURE</h1></div>
  ...
  <h1 class="text-center">Data Supplier</h1><br>
  <div><a href="input_supplier.php" class="btn  btn-success ml-3">Tambah Supplier</a></div>
      ...
      <table class="table table-bordered table-hover table-striped mt-2">   
       ...
       echo "<tr>
                ...
                <td align='right' width='20px'><a href='form_editsupplier.php?id_supplier=$spr[id_supplier]' type='button' class='btn btn-primary'>Perbaharui</a></td>
                <td  width='20px'><a href='hapussupplier.php?id_supplier=$spr[id_supplier]' class='btn btn-danger' onclick='return confirm(`Apakah Yakin Akan Dihapus?`)'>Hapus</a></td>
                  </tr>";
                  $no++;
      }
      ?>
