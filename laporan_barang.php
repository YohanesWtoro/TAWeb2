...
<div style="text-align: center; background-color: #e39434; font-family: arial;"><h1>TOKO FURNITURE</h1></div>
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      ...
      <form class="form-inline my-2 my-lg-0" action="laporan_barang.php" method="get">
  ...
  <h1 class="text-center">Laporan Data Barang</h1><br>
      ...
      ?>
      <tr>
        <td colspan="4" style="text-align: right;"><a href="cetak_barang.php" target="_BLANK" class="btn btn-success">CETAK</a></td>
      </tr>
         </table>
</div>  
